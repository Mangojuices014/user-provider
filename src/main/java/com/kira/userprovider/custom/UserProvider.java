...
import com.kira.userprovider.entity.User;
import com.kira.userprovider.entity.UserAdapter;
...
public class UserProvider implements UserStorageProvider, UserRegistrationProvider, UserQueryProvider, UserLookupProvider, CredentialInputValidator, CredentialInputUpdater {

    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(UserProvider.class);
